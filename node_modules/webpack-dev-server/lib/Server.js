...
// See https://github.com/webpack/webpack-dev-server/issues/1604 for more information
{
    ...
    SockjsSession.prototype.decorateConnection = function (req) {
        ...
        if (connection.headers && !('origin' in connection.headers) &&
...
function Server(compiler, options = {}, _log) {
    ...
    this.middleware = webpackDevMiddleware(compiler, Object.assign({}, options,
        wdmOptions));
    ...
    const features = {
            ...
            if (options.proxy) {
                ...
                if (!Array.isArray(options.proxy)) {
                    options.proxy = Object.keys(options.proxy).map((
                        ...
                        if (typeof options.proxy[context] ===
                            'string') {
                            proxyOptions = {
                        ...
                        proxyOptions.logLevel = proxyOptions
                            .logLevel || 'warn';
                ...
                options.proxy.forEach((proxyConfigOrCallback) => {
                    ...
                    proxyMiddleware = getProxyMiddleware(
                        proxyConfig);
                    ...
                    app.use((req, res, next) => {
                        ...
                        const bypassUrl = (bypass &&
                                proxyConfig.bypass(req,
                                    res, proxyConfig)
                                ) || false;
        ...
        contentBaseFiles: () => {
            if (Array.isArray(contentBase)) {
                ...
                app.get('*', express.static(contentBase, options
                    .staticOptions));
            }
        },
        contentBaseIndex: () => {
    ...
    Server.prototype.checkHost = function (headers, headerToCheck) {
        ...
        if (this.allowedHosts && this.allowedHosts.length) {
            for (let hostIdx = 0; hostIdx < this.allowedHosts
                .length; hostIdx++) {
    ...
    Server.prototype.listen = function (port, hostname, fn) {
        ...
        const returnValue = this.listeningApp.listen(port, hostname, (
            err) => {
                ...
                socket.on('connection', (connection) => {
                    ...
                    if (!this.checkHost(connection.headers) || !
                        this.checkHost(connection.headers,
                            'origin')) {
                        this.sockWrite([connection], 'error',
                    ...
                    if (this.progress) {
                        this.sockWrite([connection], 'progress',
                            this.progress);
                    }

                    if (this.clientOverlay) {
                        this.sockWrite([connection], 'overlay',
                            this.clientOverlay);
                    }

                    if (this.clientLogLevel) {
                        this.sockWrite([connection],
                            'log-level', this.clientLogLevel
                            );
                    }
                    ...
                    this._sendStats([connection], this._stats
                        .toJson(STATS), true);
                });
