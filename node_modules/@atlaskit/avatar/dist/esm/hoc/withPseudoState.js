...
export default function withPseudoState(WrappedComponent) {
  ...
  function (_Component) {
    ...
    function ComponentWithPseudoState() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "actionKeys", void 0);
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setComponent", function (component) {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getProps", function () {
