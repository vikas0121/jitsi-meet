...
function (_PureComponent) {
  ...
  function AvatarImage() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "isComponentMounted", void 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "loadImage", function () {
      // nothing to load
      if (!_this.props.src) {
        return;
      }
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleLoad", function (hasError) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleLoadSuccess", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleLoadError", function () {
