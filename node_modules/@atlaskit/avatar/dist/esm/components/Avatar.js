...
function (_Component) {
  ...
  function Avatar() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "createAndFireEventOnAtlaskit", createAndFireEvent('atlaskit'));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "clickAnalyticsCaller", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "guardedClick", function (event) {
